...
public class RevenueStatistic {
    ...
    public RevenueStatistic(Date orderDate, int orderMonth, int orderYear, int totalOrder, long totalRevenue,
            int totalProductsSold, int month, long revenue, int categoryId, String categoryName) {
