...
public class VerifyOTPServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // XÃ¡c Ä‘á»‹nh email vÃ  password theo má»¥c Ä‘Ã­ch OTP
        ...
        // âœ… In ra Ä‘á»ƒ debug
        System.out.println("ðŸ” OTP ngÆ°á»i dÃ¹ng nháº­p: " + enteredOtp);
        System.out.println("âœ… OTP há»‡ thá»‘ng lÆ°u: " + otpManager.getOtpCode());
        ...
        if ("register".equals(otpPurpose)) {
            ...
            // âœ… Gá»i hÃ m má»›i cÃ³ thÃªm khÃ¡ch hÃ ng luÃ´n
            ...
            // Chuyá»ƒn Ä‘áº¿n trang Ä‘áº·t láº¡i máº­t kháº©u
